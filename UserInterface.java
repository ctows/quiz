//User Interface class - Christopher Townsend 2015
...
public class UserInterface extends JFrame implements ActionListener {
	...
	private QuizLogic quizLogic = new QuizLogic();			// quiz logic
	...
	private WebScrape scrape = new WebScrape();		// Definition of web-scraper object
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == btnStartQuiz) {// Start Quiz
			...
			if(enteredQuestions < 4) {		// make sure the user has entered enough questions to randomize questions
				...
				wrongAnswer1 = quizLogic.randomAnswer(def);
				wrongAnswer2 = quizLogic.randomAnswer(def);
				while(wrongAnswer2.equals(wrongAnswer1)) {
					wrongAnswer2 = quizLogic.randomAnswer(def);
				}
				wrongAnswer3 = quizLogic.randomAnswer(def);
